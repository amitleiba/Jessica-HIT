...
public interface IAuthService
{
    ...
    /// <param name="fetchFromKeycloak">If true, fetches fresh user data from the identity provider. If false, uses claims from the validated token.</param>
    ...
    /// <summary>
    /// Registers a new user via the auth backend.
    /// </summary>
